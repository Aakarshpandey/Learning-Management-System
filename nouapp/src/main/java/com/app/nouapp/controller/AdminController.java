...
public class AdminController {
	...
	public String DeleteStudyMaterial(@RequestParam int id, HttpSession session, RedirectAttributes attributes,
			Model model) {
	...
	public String DeleteComplaint(@RequestParam int id, HttpSession session, RedirectAttributes attributes,
			Model model) {
	...
	public String DeleteFeedback(@RequestParam int id, HttpSession session, RedirectAttributes attributes,
			Model model) {
